...
$anonID;
			...
			if(isset($_POST['addToCart']) && !empty($_POST['quantity'])){
				if(isset($_SESSION['userLogged'])){
					...
					$equipmentDisplayer->addItemToCart("anon", $anonID, $_POST['addToCart'], $_POST['quantity']);
				}
			}
?>
...
<html>
	...
	<body>
		...
		<?php
			$selectQuery = "SELECT product_id, product_name, product_description, product_price, quantity, product_image from product";
